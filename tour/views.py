...
def add_destination(request):
    if request.method == "POST":
        ...
        Destination.objects.create(price_by_bus=pb,country=c, image=i,image1=i1,image2=i2,image3=i3,food_price=fp,number_of_person=np,days=d,nights=n,place=p,description=des)
